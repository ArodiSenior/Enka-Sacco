    ...
    private void checkSubscription() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseURL.CHECK_SUBSCRIPTION,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")){
                                ...
                                alertDialog
                                        .setMessage("Please pay registration fee of KSH 200 to continue")
                                        .setCancelable(false)
                            ...
                            Toast.makeText(HomeActivity.this, "Registration fee payment not confirmed due to unknown error", Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(HomeActivity.this, "Cannot connect to Registration payment please try again later ", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                hashMap.put("clientId",Long.toString(clientId));
                return hashMap;
            }
        };
