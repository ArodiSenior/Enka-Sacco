...
public class StkPushFragment extends Fragment  {
    ...
    View rootView;
    private  static final String urlAdress="http://207.180.239.173:9091/tech/api/mpesa/stkpush";
    private  static final String transStatus="http://207.180.239.173:9091/tech/api/mpesa/stkpushstatus";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        accountidtxt.setText(getString(R.string.accounttobepaidfor)+" M#"+ String.valueOf(accountId));
    ...
    private void payLoan(final long accountId) throws JSONException {
        // String link="http://207.180.239.173:9091/tech/api/auth/signin";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            jsonParam1.put("tenant", 2);
                            jsonParam1.put("accountReference", "M#" + accountId);
                            jsonParam1.put("transactionDesc", "Mobile Payment");
